...
export const DISMISSAL_RESPONSES: Record<string, string> = {
  ...
  "stress": "While stress can worsen symptoms, the pattern I am experiencing — particularly {topSymptom} — is consistent with the hormonal changes of perimenopause. I would like to explore hormonal assessment and evidence-based treatment options.",
